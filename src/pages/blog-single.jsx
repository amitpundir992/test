...
import blogsidebar1 from "../img/blog-sidebar1.jpg";
import blogsidebar2 from "../img/blog-sidebar2.jpg";
import blogsidebar3 from "../img/blog-sidebar3.jpg";
                  ...
                  <div class="single-main">
                    ...
                    <div class="meta">
                      <div class="meta-left">
                        ...
                        <span class="date">
                          <i class="fa fa-clock-o"></i>03 Feb 2019
                        </span>
                      </div>
                      <div class="meta-right">
                        <span class="comments">
                          <a href="#">
                            <i class="fa fa-comments"></i>05 Comments
                          </a>
                        </span>
                        <span class="views">
                          <i class="fa fa-eye"></i>33K Views
                        </span>
                      </div>
                    </div>
                    {/* News Text  */}
                        ...
                        <div class="main">
                          ...
                          <div class="body">
                            ...
                            <div class="comment-meta">
                              <span class="meta">
                                <i class="fa fa-calendar"></i>March 05, 2019
                              </span>
                              <span class="meta">
                ...
                <div class="single-widget recent-post">
                  ...
                  <div class="single-post">
                    ...
                    <div class="content">
                      ...
                      <ul class="comment">
                        <li>
                          <i class="fa fa-calendar" aria-hidden="true"></i>Jan
                          11, 2020
                        </li>
                        <li>
                  ...
                  <div class="single-post">
                    ...
                    <div class="content">
                      ...
                      <ul class="comment">
                        <li>
                          <i class="fa fa-calendar" aria-hidden="true"></i>Mar
                          05, 2019
                        </li>
                        <li>
                          <i class="fa fa-commenting-o" aria-hidden="true"></i>
